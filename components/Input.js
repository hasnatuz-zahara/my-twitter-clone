...
export default function Input() {
  return (
    <div className="flex border-b border-gray-200 p-3 space-x-3">
        <img className="h-11 w-11 rounded-full cursor-pointer hover:brightness-95 "src="https://e0.pxfuel.com/wallpapers/530/368/desktop-wallpaper-hijab-girl-cartoon-anime-hijab.jpg" alt="user-img" />
        <div className="w-full divide-y divide-gray-200" >
            ...
            <div className="flex items-center justify-between p-2.5">
                <div className="flex">
                    <PhotographIcon className="h-10 w-10 hoverEfect p-2 text-sky-500 hover:bg-sky-100"/>
