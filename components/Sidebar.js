  ...
  return (
    <div className="hidden sm:flex flex-col p-2 xl:items-start fixed h-full xl:ml-24">
        ...
        <div className="hoverEffect text-gray-700 flex items-center justify-center xl:justify-start mt-auto">
          <img className="h-10 w-10 rounded-full xl:mr-2" src="https://e0.pxfuel.com/wallpapers/530/368/desktop-wallpaper-hijab-girl-cartoon-anime-hijab.jpg" alt="user-img" />
          <div className="leading-5 hidden xl:inline">
            <h4 className="font-bold">Zee.M</h4>
            <p className="text-gray-500">@zee_M</p>
          </div>
